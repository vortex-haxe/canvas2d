package canvas._backend.bindings;
...
@:include("freetype/freetype.h")
@:buildXml("<include name='${haxelib:canvas2d}/include.xml'/>")
/**
 * @see https://github.com/BlueprintFramework-Team/Blueprint/blob/master/src/bindings/Freetype.hx
 */
